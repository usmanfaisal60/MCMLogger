...
const CheckAdressesSerial = ({
    ...
    const sendPingModbusRequest = (_socket: WebSocket) => _socket.send("/pingModbusSerial?data=" + JSON.stringify({
...
export default connect(mapStateToProps, { startMonitoring, stopMonitoring })(CheckAdressesSerial);
